...
export const Route = createFileRoute("/dream/")({
  head: () =>
    seo({
      title: "ทำนายฝันโบราณ แม่นยำ 100% — ค้นหาความฝัน เลขเด็ดงวดนี้ เลขนำโชค แก้เคล็ด",
      description:
        "พจนานุกรมทำนายฝันแม่นๆ ค้นหาความหมายความฝัน ฝันเห็นงู ฝันเห็นช้าง ฝันว่าฟันหัก ฝันเห็นคนตาย พร้อมวิเคราะห์เลขเด็ดงวดนี้ เลขมงคล ช่วงเวลาฝันบอกเหตุ และวิธีแก้เคล็ดฝันร้าย",
      path: "/dream",
      keywords: [
        "ทำนายฝัน",
        "ทำนายฝันแม่นๆ",
