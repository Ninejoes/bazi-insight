...
export const Route = createFileRoute("/articles/")({
  head: () =>
    seo({
      title: "บทความดูดวง โหราศาสตร์ และสาระสายมู — ปาจื้อ ไพ่ยิปซี ทำนายฝัน ฤกษ์มงคล",
      description:
        "คลังบทความดูดวงและโหราศาสตร์ รวมความรู้ปาจื้อ 4 เสา, ความหมายไพ่ยิปซี, ถอดรหัสทำนายฝัน, เคล็ดลับเสริมดวงการงาน การเงิน ความรัก, และพิธีกรรมเสริมสิริมงคล",
      path: "/articles",
      keywords: [
        "บทความดูดวง",
        "สาระสายมู",
