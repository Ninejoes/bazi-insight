  ...
  const channels = [
    {
      ...
      label: "อีเมล",
      value: contact?.email && contact.email !== "contact@likhitfa.online" ? contact.email : "bg.chanon@gmail.com",
      link: `mailto:${contact?.email && contact.email !== "contact@likhitfa.online" ? contact.email : "bg.chanon@gmail.com"}`,
    },
