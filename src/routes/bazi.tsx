...
export const Route = createFileRoute("/bazi")({
  head: () =>
    seo({
      title: "ดูดวงปาจื้อ 八字 ผูกดวงจีน 4 เสา วิเคราะห์ธาตุกำเนิด วัยจร 10 ปี แม่นยำ ฟรี",
      description:
        "โปรแกรมคำนวณและผูกดวงจีนปาจื้อ (BaZi Four Pillars of Destiny) คำนวณจากวันเดือนปีเกิดและเวลาตกฟาก วิเคราะห์ธาตุสำคัญ ดิถี วัยจร 10 ปี ธาตุให้คุณ-ให้โทษ และดวงชะตาชีวิตเฉพาะบุคคล",
      path: "/bazi",
      keywords: [
        "ดูดวงปาจื้อ",
        "ดูดวงจีน",
