...
export const Route = createFileRoute("/tarot/")({
  head: () =>
    seo({
      title: "ดูดวงไพ่ยิปซี Tarot แม่นยำ — เปิดไพ่ยิปซีรายวัน ความรัก การงาน การเงิน ฟรี",
      description:
        "เปิดไพ่ยิปซีทำนายดวงชะตา ไพ่ทาโรต์ 78 ใบแม่นยำ เลือกดูดวงไพ่ยิปซีรายวัน รายสัปดาห์ ความรัก เนื้อคู่ การงาน การเงิน และสุขภาพ พร้อมคำทำนายและแนวทางแก้ไข",
      path: "/tarot",
      keywords: [
        "ดูดวงไพ่ยิปซี",
        "เปิดไพ่ยิปซี",
